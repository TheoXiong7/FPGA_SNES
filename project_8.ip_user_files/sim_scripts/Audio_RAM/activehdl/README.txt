...
#
# Generated by export_simulation on Thu Dec 12 17:48:19 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './Audio_RAM.sh' script.

./Audio_RAM.sh -reset_run
...
./Audio_RAM.sh -noclean_files

For more information on the script, please type './Audio_RAM.sh -help'.
