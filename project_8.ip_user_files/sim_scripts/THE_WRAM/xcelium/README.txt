...
#
# Generated by export_simulation on Thu Dec 12 19:12:01 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './THE_WRAM.sh' script.

./THE_WRAM.sh -reset_run
...
./THE_WRAM.sh -noclean_files

For more information on the script, please type './THE_WRAM.sh -help'.
