...
HD_PWD='C:/Users/karans4/Desktop/project_8_1.xpr/project_8/project_8.runs/CGRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CGRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CGRAM.tcl
