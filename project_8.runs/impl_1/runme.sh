...
HD_PWD='C:/Users/theox/Desktop/project_8_1.xpr/project_8_1.xpr/project_8/project_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log emu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source emu.tcl -notrace
